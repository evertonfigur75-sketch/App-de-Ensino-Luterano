                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-slate-900">
                      Upload de Arquivo da Atividade (PDF, Apostila, Imagem ou Folheto)
                    </span>
                  </div>
                  {attachmentName && (
                    <button
                ...
                {attachmentName ? (
                  <div className="p-3 rounded-xl bg-white border border-amber-200 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <p className="font-bold text-slate-900">{attachmentName}</p>
                  ...
                  <div className="border-2 border-dashed border-amber-300 rounded-xl p-4 text-center hover:bg-amber-50/80 transition cursor-pointer relative">
                    <input
                      type="file"
                    ...
                    <p className="text-[10px] text-slate-500 mt-0.5">
                      Suporta PDF, Word (.docx), Imagens e Documentos de Estudo (máx. 10MB)
                    </p>
                  </div>
                )}
              </div>
